  ...
  void listen(){
    on<ForcesEvent>((event, emit) => emit(TopBarState(event.getIndex(),
        event.getTitle(), homeMenus: [
          ForcesMenu("List of all forces in the Uk", AppIcons.policeman_ic),
          ForcesMenu("See all UK emergency numbers", AppIcons.location_ill),
          ForcesMenu("See your neigbourhood Officers", AppIcons.policeman_ic),
          ForcesMenu("Misc", AppIcons.policeman_ic)
        ])));
